...
@triton.jit
def multistep_neuron_update_kernel(x_ptr, thr_ptr, spk_out_ptr, 
...
def multistep_neuron_update_triton(x, thr):
    '''
    x: [T, *, d]
    thr: [d]
    '''
    ...
    multistep_neuron_update_kernel[(B, ND)](x, thr, spk_out, T, B, BD, d)
    spk_out = spk_out.reshape(*origin_shape)
    return spk_out
